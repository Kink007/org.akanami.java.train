 ...
 *  加载Component01时注解  @ConditionalOnProperty(value = "akanami.onpropertys.component01.enable", havingValue = "true",  matchIfMissing = false)
 *  因为application.yml中该项配置为true，因此可以加载Component01 至容器中
 *
 *  加载Component02 时注解  @ConditionalOnProperty(value = "akanami.onpropertys.component02.enable", havingValue = "true",  matchIfMissing = false)
 *  因为application.yml中该项配置为false，因此Component02 不能被注入至容器中
 */
@RunWith(SpringRunner.class)
@SpringBootTest(classes = OnPropertyConfiguration.class)
public class OnPropertyConfigurationTest {
